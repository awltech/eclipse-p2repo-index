...
public class P2RepoIndexGeneratorMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			...
			List<FeatureDescriptor> featureDescriptors = getFeatureDescriptors(repoPath);
			Collections.sort(featureDescriptors);
	...
	private List<FeatureDescriptor> getFeatureDescriptors(String repoPath) {
			...
			if (contentsFileInputStream != null) {
				...
				for (Object o : units.getChildren("unit")) {
					...
					if (isFeature) {
						...
						descriptors.add(new FeatureDescriptor(featureId, featureName, featureVersion));
					}
				}
