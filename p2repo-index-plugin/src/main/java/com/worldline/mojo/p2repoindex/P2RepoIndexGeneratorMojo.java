...
public class P2RepoIndexGeneratorMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			...
			writer.write("</p></section><section><p><h3>Available features within this update site:</h3></p><p>\n");
			...
			try {
				builtInformation = ", for an Update Site built on "
						+ sdf.format(new Date(Long.parseLong(repositoryDescriptor.getTimestamp())));
			...
			writer.write("</p><p><div><i>(Generated by <a href= \"https://github.com/awltech/eclipse-p2repo-index\">AWLTech p2repo-index-plugin</a> on "
					+ sdf.format(new Date()) + builtInformation + ".)</i></div>");
